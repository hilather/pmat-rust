...
CODE:
  {
    void *ptr;
    struct pmat_sv *sv;
    /* Allocate subtype storage and zero it so DESTROY can safely free
     * optional arrays (elems_at / values_at) when load() was never called
     * (e.g. Rust-backend lightweight proxies). */
    switch(type) {
      case 1: /* PMAT_SVtGLOB */
        Newxz(ptr, 1, struct pmat_sv_glob); break;
      case 2: /* PMAT_SVtSCALAR */
      case 13: /* PMAT_SVtUNDEF */
      case 14: /* PMAT_SVtYES */
      case 15: /* PMAT_SVtNO */
        Newxz(ptr, 1, struct pmat_sv_scalar); break;
      case 3: /* PMAT_SVtREF */
        Newxz(ptr, 1, struct pmat_sv_ref); break;
      case 4: /* PMAT_SVtARRAY */
        Newxz(ptr, 1, struct pmat_sv_array); break;
      case 5: /* PMAT_SVtHASH */
      case 6: /* PMAT_SVtSTASH */
      case 17: /* PMAT_SVtCLASS */
        Newxz(ptr, 1, struct pmat_sv_hash); break;
      case 7: /* PMAT_SVtCODE */
        Newxz(ptr, 1, struct pmat_sv_code); break;
      case 16: /* PMAT_SVtOBJECT */
        Newxz(ptr, 1, struct pmat_sv_object); break;
      case 0x7F: /* PMAT_SVtSTRUCT */
        Newxz(ptr, 1, struct pmat_sv_struct); break;
      default:
        Newxz(ptr, 1, struct pmat_sv); break;
    }
